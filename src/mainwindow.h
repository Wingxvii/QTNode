...
private:
    ...
    //Contains most of the UI
    //Controls the menu bar at the top of the application
    Ui::MainWindow* ui;
    Player* m_player;
    ...
    //Campbells variables
    SensorWindow* m_sensorWindow;
    ScrubEventManager* scrubEventLayout;
...
private slots:
    ...
    //Campbells slots
    void onSensorDockTriggered(bool checked = true);
