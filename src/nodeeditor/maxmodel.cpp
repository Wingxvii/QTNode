...
QJsonObject MaxModel::save() const
{
    return QJsonObject();
}

unsigned int MaxModel::nPorts(QtNodes::PortType portType) const
{
...
NodeDataType MaxModel::dataType(QtNodes::PortType portType, QtNodes::PortIndex PortIndex) const
{
    return NodeGraphData().type();
}

std::shared_ptr<NodeData> MaxModel::outData(QtNodes::PortIndex)
{
    return _result;
}

void MaxModel::setInData(std::shared_ptr<NodeData> data, PortIndex index)
{
...
void MaxModel::onTextEdited()
{
    calculateResult();
}

void MaxModel::calculateResult()
{
    auto g1 = _data.lock();
...
QWidget* MaxModel::embeddedWidget()
{
    return _lineEdit;
}

NodeValidationState MaxModel::validationState() const
{
    return modelValidationState;
}

QString MaxModel::validationMessage() const
{
