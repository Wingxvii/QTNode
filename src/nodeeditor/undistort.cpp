...
cv::Mat UnDistort::multiThreadedProcess(const cv::Mat &in)
{
...
void UnDistort::processData(){
    ...
    QFuture<cv::Mat> f = QtConcurrent::mapped(videoList.begin(), videoList.end(), &UnDistort::multiThreadedProcess);
