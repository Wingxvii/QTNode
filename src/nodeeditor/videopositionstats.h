#ifndef VIDEOPOSITIONSTATS_H
#define VIDEOPOSITIONSTATS_H
...
class VideoPositionStats: public NodeDataModel
{   Q_OBJECT
public:
    VideoPositionStats();
    virtual ~VideoPositionStats(){};

public: //required classes
    QString caption() const override{
        return QStringLiteral("Position Stats");
    }
    bool captionVisible(){
        return false;
    }
