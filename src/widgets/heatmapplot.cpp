...
HeatMapPlot::HeatMapPlot( QWidget *parent ):
    QwtPlot( parent ),
    d_alpha(255)
{
    ...
    setColorMap( HeatMapPlot::RGBMap );
...
void HeatMapPlot::showContour( bool on )
{
    d_spectrogram->setDisplayMode( QwtPlotSpectrogram::ContourMode, on );
    replot();
}

void HeatMapPlot::showSpectrogram( bool on )
{
...
void HeatMapPlot::setColorMap( int type )
{
